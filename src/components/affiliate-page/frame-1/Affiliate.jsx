      ...
      <div className="container header">
        <div className="header-content">
          <div className="header-text">
            ...
            <p>
              Are you passionate about remote work and helping others find
              fulfilling career opportunities? Join ZealWorkers as an affiliate
              and start earning commissions today!
            </p>
            <p>
              As a ZealWorkers affiliate, you'll have access to exclusive

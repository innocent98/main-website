        ...
        <div className="freelancer-profile-left">
          ...
          <div className="freelancer-bio">
            ...
            <p>
              ...
              Aspernatur, obcaecati esse? Dignissimos, voluptates labore! Quas
              nobis reiciendis, minima et, rerum, qui ducimus autem animi eaque
              fugit molestiae? Odio, voluptates est.
            </p>
          </div>
              ...
              <div className="review-box">
                <div className="reviewer-info">
                  <div>
                    {" "}
                    <div>
                      <img src={profileProject} /> <p>Mustapha Costa</p>
                    </div>
                  </div>
                  <div>
                    {" "}
                    <Rating
                      ...
                      readOnly
                    />{" "}
                    <span className="span">November 21 2023</span>
                  </div>
                </div>
              ...
              <div className="review-box">
                <div className="reviewer-info">
                  <div>
                    {" "}
                    <div>
                      <img src={profileProject} /> <p>Costa Costa</p>
                    </div>
                  </div>
                  <div>
                    {" "}

  ...
  return (
    <Layout footerLayout={footerLayout}>
      ...
      <Container variant="wrapper--flex--between">
        <section>
          <p>
            <FaUser /> Build your Profile
          </p>
          <p>
            <BiSolidEnvelope /> Apply for Jobs
          </p>
          <p>
            <FaUser /> Get Paid Instantly
          </p>
          <Container variant="wrapper--flex" className="wrapper--flex__visible">
            ...
            <p className="wrapper--flex--between__text">
              It takes only few steps to create your profile and you can edit it
              later.
            </p>
          </Container>
        </section>

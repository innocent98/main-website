    ...
    <>
      <Layout footerLayout={true}>
        <main className="wrapper--padded__children-intro">
          ...
          <p>
            We would like you to provide us some information to create your
            profile and you can edit it later
          </p>
          ...
          <div className="form">
            ...
            <div>
              <label style={{ marginBottom: "0px" }} htmlFor="Name">
                Company Name
              </label>
              <input className="com-name" placeholder="Name of your company" />
            </div>
            <div>
              <label style={{ marginBottom: "0px" }} htmlFor="desc">
                Company description
              </label>
              <textarea
                className="com-desc"
        ...
        {isModalOpen && (
          <Modal className="modal">
            ...
            <Container variant="wrapper--flex" className="modal--btnSec">
              <Button variant="border--fit" onClick={handleModalOpen}>
                Cancel
              </Button>
              <Button
                variant="default--fit"
